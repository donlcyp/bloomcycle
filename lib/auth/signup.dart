...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _signUpWithGoogle() async {
    ...
    try {
      ...
      final profileEmail = refreshedUser.email ?? signupInfo.email;
      final profileDisplayName = (refreshedUser.displayName ?? displayName)
          .trim();
      ...
      await FirebaseService.createUser(user.uid, {
        'profile': {
          'firstName': firstName,
          'lastName': lastName,
          'displayName': profileDisplayName.isNotEmpty
              ? profileDisplayName
              : profileEmail,
          'email': profileEmail,
