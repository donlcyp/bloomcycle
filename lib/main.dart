...
void main() async {
  ...
  final savedLanguage = UserState.currentUser.settings.appPreferences.language;
  LanguageService.setLanguageName(savedLanguage);
          ...
          theme: ThemeData(
            ...
            outlinedButtonTheme: OutlinedButtonThemeData(
              style: OutlinedButton.styleFrom(
                side: BorderSide(
                  color: baseColorScheme.primary.withValues(alpha: 0.4),
                ),
